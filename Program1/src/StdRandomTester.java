/******************************************************************************
 *  Compilation:  javac StdRandomTester.java
...
// (x can be of type Object[], double[], int[], ...)
    ...
    public static void main(String[] args) {
        ...
        int m = 0;
        if (args.length == 2) StdRandomTester.setSeed(Long.parseLong(args[1]));
        double[] probabilities = { 0.5, 0.3, 0.1, 0.1 };
        int[] frequencies = { 5, 3, 1, 1 };
        String[] a = "A B C D E F G".split(" ");
        StdOut.println("seed = " + StdRandomTester.getSeed());
        for (int i = 0; i < n; i++) {
...
//            StdOut.printf("%11d ",  uniform(100000000000L));
        ...
        System.out.println(m + "----------------------------");
         ...
         n = Integer.parseInt(args[0] +"0");
         m = 0;
        if (args.length == 2) StdRandomTester.setSeed(Long.parseLong(args[1]));
        double[] probabilities2 = { 0.5, 0.3, 0.1, 0.1 };
        int[] frequencies2 = { 5, 3, 1, 1 };
...
//            StdOut.printf("%2d ",   uniform(100));
            ...
            StdOut.printf("%5b ",   bernoulli(0.5));
//            StdOut.printf("%7.5f ", gaussian(9.0, 0.2));
//            StdOut.printf("%1d ",   discrete(probabilities2));
//            StdOut.printf("%1d ",   discrete(frequencies2));
//            StdOut.printf("%11d ",  uniform(100000000000L));
            StdRandomTester.shuffle(a2);
            for (String s : a2)
                StdOut.print(s);
            StdOut.println();
            m++;
